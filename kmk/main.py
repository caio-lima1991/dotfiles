...
keyboard.keymap = [
    [
        ...
        KC.LSFT,    KC.Z,       KC.X,       KC.C,       KC.V,       KC.B,       KC.N,       KC.M,       KC.COMM,    KC.DOT,     KC.SLSH,    KC.RSFT,
                                KC.LGUI,    KC.LCTL,    KC.ENTER,   KC.HOME,    KC.END,     KC.MO(1),    KC.SPACE,   KC.RALT
    ],
    [
        KC.F12,     KC.F1,      KC.F2,      KC.F3,      KC.F4,      KC.F5,      KC.F6,      KC.F7,      KC.F8,      KC.F9,      KC.F10,         KC.F11,
        KC.GRV,     KC.MPRV,    KC.MNXT,    KC.MPLY,    KC.NO,      KC.NO,      KC.MINS,    KC.EQL,     KC.RBRC,    KC.BSLS,    KC.NONUS_BSLASH,KC.PGUP,
        KC.TRNS,    KC.MUTE,    KC.VOLD,    KC.VOLU,    KC.NO,      KC.NO,      KC.LEFT,    KC.DOWN,    KC.UP,      KC.RIGHT,   KC.NO,          KC.PGDN,
        KC.LSFT,    KC.CAPS,    KC.X,       KC.NO,      KC.NO,      KC.NO,      KC.NO,      KC.NO,      KC.NO,      KC.NO,      KC.NO,          KC.RSFT,
